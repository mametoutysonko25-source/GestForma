...
-- --------------------------------------------------------
-- Domaine D1 — Utilisateurs et accès
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Domaine D2 — Formation et pédagogie
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Domaine D3 — Planification et présence
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Domaine D4 — Évaluations et ressources
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Domaine D5 — Inscriptions et finances
-- --------------------------------------------------------
...
(1, 'Ndiaye', 'Moussa', 'admin@test.com', '770000001', 'admin', 'admin123', 'ACTIF', '2026-09-14 15:39:08', NULL),
(2, 'Fall', 'Awa', 'pedagogie@test.com', '770000002', 'responsable_pedago', 'pedago123', 'ACTIF', '2026-09-14 15:39:08', NULL),
(3, 'Ba', 'Ousmane', 'comptable@test.com', '770000003', 'comptable', 'compta123', 'ACTIF', '2026-09-14 15:39:08', NULL),
(4, 'Diop', 'Fatou', 'formateur@test.com', '770000004', 'formateur', 'form123', 'ACTIF', '2026-09-14 15:39:08', NULL),
(5, 'Sarr', 'Ibrahima', 'etudiant@test.com', '770000005', 'etudiant', 'etu123', 'ACTIF', '2026-09-14 15:39:08', NULL);

INSERT INTO `ADMINISTRATEUR` (`idUtilisateur`) VALUES (1);
INSERT INTO `DIRECTEUR` (`idUtilisateur`) VALUES (2);
INSERT INTO `RESPONSABLE_PEDAGOGIQUE` (`idUtilisateur`, `matricule`, `specialite`, `datePriseFonction`) VALUES (2, 'RP-2026-001', 'Pédagogie', '2026-09-01');
INSERT INTO `FORMATEUR` (`idUtilisateur`, `matricule`, `specialite`, `adresse`, `experience`, `disponibilites`, `tarifHoraire`) VALUES (4, 'FORM-2026-001', 'Développement web', 'Dakar', 5, 'Lundi-Vendredi', 7500.00);
INSERT INTO `COMPTABLE` (`idUtilisateur`) VALUES (3);
INSERT INTO `ETUDIANT` (`idUtilisateur`, `matricule`, `dateNaissance`, `lieuNaissance`, `sexe`, `adresse`, `photo`, `personneUrgence`, `telephoneUrgence`, `dateInscription`, `situationProfessionnelle`, `statutParcours`) VALUES (5, 'ETU-2026-001', '2002-05-12', 'Dakar', 'M', 'Pikine, Dakar', NULL, 'Parent', '770000006', '2026-09-14', 'Étudiant', 'EN_COURS');
INSERT INTO `FORMATION` (`idFormation`, `nom`, `description`, `duree`) VALUES (1, 'Développement web', 'Formation en développement web et bases de données', 12);
INSERT INTO `NIVEAU` (`idNiveau`, `libelle`, `ordre`, `idFormation`) VALUES (1, 'L1', 1, 1);
INSERT INTO `SEMESTRE` (`idSemestre`, `libelle`, `ordre`, `description`, `idNiveau`) VALUES (1, 'S1', 1, 'Premier semestre', 1);
INSERT INTO `MODULE` (`idModule`, `code`, `libelle`, `description`, `volumeHoraire`, `idSemestre`, `idFormateur`) VALUES (1, 'SQL101', 'Bases de données', 'Introduction à MySQL et à la conception relationnelle', 40, 1, 4);
INSERT INTO `SEANCE` (`idSeance`, `dateSeance`, `heureDebut`, `heureFin`, `statut`, `idModule`, `idFormateur`) VALUES (1, '2026-10-05', '08:00:00', '10:00:00', 'VALIDEE', 1, 4);
INSERT INTO `PRESENCE` (`idPresence`, `statutPresence`, `heureArrivee`, `justification`, `dateJustification`, `validee`, `idSeance`, `idEtudiant`) VALUES (1, 'PRESENT', NULL, NULL, NULL, 1, 1, 5);
INSERT INTO `DOSSIER_ETUDIANT` (`idDossier`, `anneeScolaire`, `statut`, `dateCreation`, `idEtudiant`) VALUES (1, '2026-2027', 'ACTIF', '2026-09-14 15:39:08', 5);
INSERT INTO `INSCRIPTION` (`idInscription`, `dateInscription`, `statut`, `idDossier`, `idNiveau`) VALUES (1, '2026-09-14', 'VALIDEE', 1, 1);
INSERT INTO `PAIEMENT` (`idPaiement`, `montant`, `datePaiement`, `modePaiement`, `reference`, `idInscription`) VALUES (1, 100000.00, '2026-09-14 15:39:10', 'ESPECES', 'PAY-2026-0001', 1);
INSERT INTO `REMUNERATION_FORMATEUR` (`idRemuneration`, `mois`, `heuresValidees`, `montantDu`, `montantPaye`, `statut`, `idFormateur`) VALUES (1, '2026-09', 2.00, 15000.00, 0.00, 'A_PAYER', 4);
