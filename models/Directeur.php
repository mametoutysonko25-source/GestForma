...
class Directeur
{
    ...
    {
        $requete = database()->query(
            "SELECT u.idUtilisateur, u.prenom, u.nom, u.email, u.telephone, u.statutCompte, 'Directeur' AS role, 'directeur' AS roleKey
             FROM utilisateur u INNER JOIN directeur p ON p.idUtilisateur = u.idUtilisateur
             UNION ALL
             SELECT u.idUtilisateur, u.prenom, u.nom, u.email, u.telephone, u.statutCompte, 'Responsable pédagogique', 'responsable'
             FROM utilisateur u INNER JOIN responsable_pedagogique p ON p.idUtilisateur = u.idUtilisateur
             UNION ALL
             SELECT u.idUtilisateur, u.prenom, u.nom, u.email, u.telephone, u.statutCompte, 'Formateur', 'formateur'
             FROM utilisateur u INNER JOIN formateur p ON p.idUtilisateur = u.idUtilisateur
             UNION ALL
             SELECT u.idUtilisateur, u.prenom, u.nom, u.email, u.telephone, u.statutCompte, 'Comptable', 'comptable'
             FROM utilisateur u INNER JOIN comptable p ON p.idUtilisateur = u.idUtilisateur
             UNION ALL
             SELECT u.idUtilisateur, u.prenom, u.nom, u.email, u.telephone, u.statutCompte, 'Administrateur', 'administrateur'
