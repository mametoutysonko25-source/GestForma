...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'supprimer' && isset($_POST['idNiveau'])) {
        try {
            ...
            $erreur = "Impossible de supprimer ce niveau : des semestres ou des inscriptions y sont encore rattachés.";
        }
            ...
            <?php foreach ($niveaux as $niveau): ?>
                <tr style="border-bottom:1px solid #eee;">
                    ...
                    <td style="padding:10px;">
                        <a href="<?= htmlspecialchars(BASE_URL . 'views/responsable/semestres.php') ?>" style="color:var(--primary);">
                            <?= (int) $niveau['nbSemestres'] ?> semestre(s)
                        </a>
                    </td>
...
<p style="margin-top:16px; font-size:13px; color:var(--muted);">
    La gestion des semestres se fait désormais depuis la page <a href="<?= htmlspecialchars(BASE_URL . 'views/responsable/semestres.php') ?>" style="color:var(--primary);">Semestres</a>.
</p>
